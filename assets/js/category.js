    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        data.forEach(function(item) {
          $('.category').append('<div class="p-v-xs"><a href="/category.php?id=' + item.id + '" class="text-info">' + item.name + '</a><a class="remove cursor-pointer text-danger m-l-sm" data="' + item.id + '">&#10006;</a></div>');
        });
